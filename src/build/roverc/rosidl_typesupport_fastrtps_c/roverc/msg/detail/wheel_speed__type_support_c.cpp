  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roverc__msg__WheelSpeed;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const roverc__msg__WheelSpeed * ros_message = static_cast<const roverc__msg__WheelSpeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_roverc__msg__WheelSpeed(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  roverc__msg__WheelSpeed * ros_message = static_cast<roverc__msg__WheelSpeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_roverc__msg__WheelSpeed(cdr, ros_message);
}
