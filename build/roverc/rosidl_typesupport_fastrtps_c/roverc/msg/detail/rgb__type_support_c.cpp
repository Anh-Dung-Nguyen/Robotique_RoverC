...
#include "roverc/msg/detail/rgb__rosidl_typesupport_fastrtps_c.h"
...
using _RGB__ros_msg_type = roverc__msg__RGB;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roverc__msg__RGB;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const roverc__msg__RGB * ros_message = static_cast<const roverc__msg__RGB *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_roverc__msg__RGB(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  roverc__msg__RGB * ros_message = static_cast<roverc__msg__RGB *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_roverc__msg__RGB(cdr, ros_message);
}

static uint32_t _RGB__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roverc__msg__RGB(
...
static size_t _RGB__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roverc__msg__RGB(
